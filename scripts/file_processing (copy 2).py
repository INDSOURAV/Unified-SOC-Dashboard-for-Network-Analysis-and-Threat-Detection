...
def generate_file_extraction_report(extracted_files_folder='../extract_files', threat_hunting_json_path='../uploads/enriched_output.json'):
...
print(generate_file_extraction_report())
